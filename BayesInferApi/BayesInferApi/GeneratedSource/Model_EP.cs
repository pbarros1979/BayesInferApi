...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.1810.501 at 12:04 on quinta-feira, 16 de maio de 2019.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>Message to marginal of 'Câibras'</summary>
		public DistributionRefArray<Discrete,int> Câibras_marginal_F;
		...
		/// <summary>True if Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40 has executed. Set this to false to force re-execution of Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40</summary>
		public bool Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40_isDone;
		...
		/// <summary>True if Changed_MáMinusabsorção_NofE has executed. Set this to false to force re-execution of Changed_MáMinusabsorção_NofE</summary>
		public bool Changed_MáMinusabsorção_NofE_isDone;
		/// <summary>True if Changed_MáMinusabsorção_NofE_ProbMáMinusabsorçãoPrior has executed. Set this to false to force re-execution of Changed_MáMinusabsorção_NofE_ProbMáMinusabsorçãoPrior</summary>
		public bool Changed_MáMinusabsorção_NofE_ProbMáMinusabsorçãoPrior_isDone;
		...
		/// <summary>Field backing the MáMinusabsorção property</summary>
		private int[] máMinusabsorção;
		public DistributionRefArray<Discrete,int> MáMinusabsorção_marginal;
		...
		/// <summary>Message to marginal of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia'</summary>
		public DistributionRefArray<Discrete,int> Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_marginal_F;
		...
		public Dirichlet[][][][][] CPTCaracterísticas_definidorasPrior
		{
			...
			set {
				...
				this.Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40_isDone = false;
		...
		/// <summary>The externally-specified value of 'MáMinusabsorção'</summary>
		public int[] MáMinusabsorção
		{
			get {
				return this.máMinusabsorção;
			}
			set {
				if ((value!=null)&&(value.Length!=this.nofE)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+this.nofE)+" was expected for variable \'MáMinusabsorção\'");
				}
				this.máMinusabsorção = value;
				this.numberOfIterationsDone = 0;
				this.Changed_MáMinusabsorção_NofE_ProbMáMinusabsorçãoPrior_isDone = false;
				this.Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40_isDone = false;
				this.Changed_MáMinusabsorção_NofE_isDone = false;
			}
		}
		...
		{
			return this.Câibras_marginal_F;
		}
		...
		/// <summary>Computations that depend on the observed value of CPTCaracterísticas_definidorasPrior and CPTControle_da_DorPrior and CPTControle_da_NutriçãoPrior and CPTControle_de_EletrólitosPrior and CPTControle_de_MedicamentosPrior and CPTControle_HídricoPrior and CPTControle_HidroeletrolíticoPrior and CPTControle_IntestinalPrior and CPTCotrole_da_DiarreiaPrior and CPTCuidados_com_OstomiasPrior and CPTDiarreiaPrior and CPTFR_FisiológicosPrior and CPTFR_PsicológicosPrior and CPTFR_SituacionaisPrior and CPTOutro_diagnósticoPrior and CPTRealizar_Outro_DiagnósticoPrior and CPTSuporte_EmocionalPrior and Dor_abdominal and MáMinusabsorção and NofE and ProbAbuso_de_álcoolPrior and ProbAbuso_de_laxantesPrior and ProbAlimentação_por_sondaPrior and ProbAltos_níveis_de_estressePrior and ProbAnsiedadePrior and ProbCâibrasPrior and ProbContaminaçãoPrior and ProbEfeitos_adversos_de_medicamentosPrior and ProbInflamaçãoPrior and ProbIrritaçãoPrior and ProbParasitasPrior and ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_diaPrior and ProbProcessos_infecciososPrior and ProbRadiaçãoPrior and ProbRuídos_intestinais_hiperativosPrior and ProbToxinasPrior and ProbUrgência_para_evacuarPrior and ProbViagemPrior</summary>
		private void Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40()
		{
			if (this.Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40_isDone) {
				return ;
			}
			...
			DistributionRefArray<Dirichlet,Vector> ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F;
			// Create array for 'ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep' Forwards messages.
			ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F = new DistributionRefArray<Dirichlet,Vector>(this.nofE);
			...
			Dirichlet ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F_marginal;
			// Message to 'ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep' from Replicate factor
			ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Dirichlet>(this.probPelo_menos_três_evacuações_de_fezes_líquidas_por_diaPrior);
			...
			// Message to 'ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep' from Replicate factor
			ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F_marginal = ReplicateOp_Divide.Marginal<Dirichlet>(ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_B_toDef, this.probPelo_menos_três_evacuações_de_fezes_líquidas_por_diaPrior, ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F_marginal);
			...
			DistributionRefArray<Discrete,int> Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F;
			// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia' Forwards messages.
			Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F = new DistributionRefArray<Discrete,int>(this.nofE);
			// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]> Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(this.nofE);
			...
			// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B_toDef'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]> Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B_toDef = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(this.nofE);
			...
			DistributionRefArray<Discrete,int> Câibras_F;
			// Create array for 'Câibras' Forwards messages.
			Câibras_F = new DistributionRefArray<Discrete,int>(this.nofE);
			...
			DistributionRefArray<Dirichlet,Vector> ProbCâibras_rep_F;
			// Create array for 'ProbCâibras_rep' Forwards messages.
			ProbCâibras_rep_F = new DistributionRefArray<Dirichlet,Vector>(this.nofE);
			Dirichlet ProbCâibras_rep_F_marginal;
			// Message to 'ProbCâibras_rep' from Replicate factor
			ProbCâibras_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Dirichlet>(this.probCâibrasPrior);
			Dirichlet ProbCâibras_rep_B_toDef;
			// Message to 'ProbCâibras_rep' from Replicate factor
			ProbCâibras_rep_B_toDef = ReplicateOp_Divide.ToDefInit<Dirichlet>(this.probCâibrasPrior);
			// Message to 'ProbCâibras_rep' from Replicate factor
			ProbCâibras_rep_F_marginal = ReplicateOp_Divide.Marginal<Dirichlet>(ProbCâibras_rep_B_toDef, this.probCâibrasPrior, ProbCâibras_rep_F_marginal);
			// Create array for 'Câibras_marginal' Forwards messages.
			this.Câibras_marginal_F = new DistributionRefArray<Discrete,int>(this.nofE);
			DistributionRefArray<Discrete,int> Câibras_use_B;
			// Create array for 'Câibras_use' Backwards messages.
			Câibras_use_B = new DistributionRefArray<Discrete,int>(this.nofE);
			// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][][][] Irritação_N_2_StateParasitas_selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][];
			...
			// Create array for replicates of 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F_marginal'
			DistributionRefArray<DistributionRefArray<Discrete,int>,int[]> Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F_marginal = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(this.nofE);
			// Create array for replicates of 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B_toDef'
			DistributionRefArray<DistributionRefArray<Discrete,int>,int[]> Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B_toDef = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(this.nofE);
			...
			// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_F_marginal'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]> Irritação_N_2_StateParasitas_selector_uses_F_marginal = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(this.nofE);
			// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_B_toDef'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]> Irritação_N_2_StateParasitas_selector_uses_B_toDef = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(this.nofE);
			...
			// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F'
			Discrete[][][][][] Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F = new Discrete[this.nofE][][][][];
			...
			// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][][][] Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][];
			// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][][][] Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][];
			// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]> Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>(this.nofE);
			// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B'
			Discrete[][][][] Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B = new Discrete[this.nofE][][][];
			// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F'
			Discrete[][][][] Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F = new Discrete[this.nofE][][][];
			...
			// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>,bool[][][][]> Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>,bool[][][][]>(this.nofE);
			...
			// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B'
			Discrete[][][][][] Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B = new Discrete[this.nofE][][][][];
			...
			// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][][][][] Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][][];
			...
			// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][][][][] Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][][];
			// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][][][][] Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][][];
			// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>,bool[][][][]> Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>,bool[][][][]>(this.nofE);
			// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B'
			Discrete[][][][][] Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B = new Discrete[this.nofE][][][][];
			// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F'
			Discrete[][][][][] Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F = new Discrete[this.nofE][][][][];
			...
			// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][][][] FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][];
			// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][][][] FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][];
			// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]> FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>(this.nofE);
			// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B'
			Discrete[][][][] FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B = new Discrete[this.nofE][][][];
			// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F'
			Discrete[][][][] FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F = new Discrete[this.nofE][][][];
			...
			// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][][][][] Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][][];
			// Create array for replicates of 'Características_definidoras_N_4_StateCâibras_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>,int[][][][]> Características_definidoras_N_4_StateCâibras_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>,int[][][][]>(this.nofE);
			// Create array for replicates of 'Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]> Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>(this.nofE);
			...
			// Create array for replicates of 'CPTCaracterísticas_definidoras_itemDor_abdominal_N__B'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]> CPTCaracterísticas_definidoras_itemDor_abdominal_N__B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]>(2);
			// Create array for replicates of 'CPTCaracterísticas_definidoras_itemDor_abdominal_N__F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]> CPTCaracterísticas_definidoras_itemDor_abdominal_N__F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]>(2);
			// Create array for replicates of 'CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]> CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]>(2);
			...
			for(int StateUrgência_para_evacuar = 0; StateUrgência_para_evacuar<2; StateUrgência_para_evacuar++) {
				...
				// Create array for replicates of 'CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal'
				CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal[StateUrgência_para_evacuar] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>(2);
				// Create array for 'CPTCaracterísticas_definidoras_use' Backwards messages.
				...
				// Create array for replicates of 'CPTCaracterísticas_definidoras_itemDor_abdominal_N__B'
				CPTCaracterísticas_definidoras_itemDor_abdominal_N__B[StateUrgência_para_evacuar] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>(2);
				// Create array for replicates of 'CPTCaracterísticas_definidoras_itemDor_abdominal_N__F'
				CPTCaracterísticas_definidoras_itemDor_abdominal_N__F[StateUrgência_para_evacuar] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>(2);
				for(int StateRuídos_intestinais_hiperativos = 0; StateRuídos_intestinais_hiperativos<2; StateRuídos_intestinais_hiperativos++) {
					...
					// Create array for replicates of 'CPTCaracterísticas_definidoras_itemDor_abdominal_N__F'
					CPTCaracterísticas_definidoras_itemDor_abdominal_N__F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(2);
					// Create array for replicates of 'CPTCaracterísticas_definidoras_itemDor_abdominal_N__B'
					CPTCaracterísticas_definidoras_itemDor_abdominal_N__B[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(2);
					// Create array for replicates of 'CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal'
					...
					for(int StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia = 0; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia<2; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia++) {
						...
						// Message to 'CPTCaracterísticas_definidoras_itemDor_abdominal_N_' from GetItems factor
						CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = GetItemsOp<Vector[]>.MarginalInit<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>>(CPTCaracterísticas_definidoras_F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia]);
						for(int StateCâibras = 0; StateCâibras<2; StateCâibras++) {
							for(int StateDor_abdominal = 0; StateDor_abdominal<2; StateDor_abdominal++) {
						...
						// Create array for 'CPTCaracterísticas_definidoras_itemDor_abdominal_N_' Forwards messages.
						CPTCaracterísticas_definidoras_itemDor_abdominal_N__F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(this.nofE);
						// Create array for 'CPTCaracterísticas_definidoras_itemDor_abdominal_N_' Backwards messages.
						CPTCaracterísticas_definidoras_itemDor_abdominal_N__B[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(this.nofE);
						// Message to 'CPTCaracterísticas_definidoras_itemDor_abdominal_N_' from GetItems factor
						CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = GetItemsOp<Vector[]>.Marginal<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,DistributionRefArray<Dirichlet,Vector>>(CPTCaracterísticas_definidoras_F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia], CPTCaracterísticas_definidoras_use_B[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia], CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia]);
					}
				}
			}
			for(int N = 0; N<this.nofE; N++) {
				for(int StateUrgência_para_evacuar = 0; StateUrgência_para_evacuar<2; StateUrgência_para_evacuar++) {
					for(int StateRuídos_intestinais_hiperativos = 0; StateRuídos_intestinais_hiperativos<2; StateRuídos_intestinais_hiperativos++) {
						for(int StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia = 0; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia<2; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia++) {
							// Create array for 'CPTCaracterísticas_definidoras_itemDor_abdominal_N_' Forwards messages.
							CPTCaracterísticas_definidoras_itemDor_abdominal_N__F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][N] = new DistributionRefArray<Dirichlet,Vector>(2);
							// Create array for 'CPTCaracterísticas_definidoras_itemDor_abdominal_N_' Backwards messages.
							CPTCaracterísticas_definidoras_itemDor_abdominal_N__B[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][N] = new DistributionRefArray<Dirichlet,Vector>(2);
							for(int StateCâibras = 0; StateCâibras<2; StateCâibras++) {
								CPTCaracterísticas_definidoras_itemDor_abdominal_N__B[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][N][StateCâibras] = ArrayHelper.MakeUniform<Dirichlet>(this.cPTCaracterísticas_definidorasPrior[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][this.dor_abdominal[N]][StateCâibras]);
								CPTCaracterísticas_definidoras_itemDor_abdominal_N__F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][N][StateCâibras] = ArrayHelper.MakeUniform<Dirichlet>(this.cPTCaracterísticas_definidorasPrior[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][this.dor_abdominal[N]][StateCâibras]);
							}
							// Message to 'CPTCaracterísticas_definidoras_itemDor_abdominal_N_' from GetItems factor
							CPTCaracterísticas_definidoras_itemDor_abdominal_N__F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][N] = GetItemsOp<Vector[]>.ItemsAverageConditional<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,DistributionRefArray<Dirichlet,Vector>>(CPTCaracterísticas_definidoras_itemDor_abdominal_N__B[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][N], CPTCaracterísticas_definidoras_F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia], CPTCaracterísticas_definidoras_use_F_StateUrgência_para_evacuar__StateRuídos_intestinais_hiperativos__StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia__marginal[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia], this.dor_abdominal, N, CPTCaracterísticas_definidoras_itemDor_abdominal_N__F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][N]);
						}
					}
				}
			}
			// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]> Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>(this.nofE);
			...
			// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]> Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>(this.nofE);
			...
			// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]> FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(this.nofE);
			// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_uses_B'
			Discrete[][][][][] Inflamação_N_3_StateIrritação_selector_uses_B = new Discrete[this.nofE][][][][];
			// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_uses_F'
			Discrete[][][][][] Inflamação_N_3_StateIrritação_selector_uses_F = new Discrete[this.nofE][][][][];
			...
			// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][][][] Irritação_N_2_StateParasitas_selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][];
			// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]> Irritação_N_2_StateParasitas_selector_cases_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>(this.nofE);
			// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_B'
			Discrete[][][][] Irritação_N_2_StateParasitas_selector_uses_B = new Discrete[this.nofE][][][];
			// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_F'
			Discrete[][][][] Irritação_N_2_StateParasitas_selector_uses_F = new Discrete[this.nofE][][][];
			...
			// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B_toDef'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]> FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B_toDef = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(this.nofE);
			// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>,bool[][][][]> Inflamação_N_3_StateIrritação_selector_cases_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>,bool[][][][]>(this.nofE);
			// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][][][][] Inflamação_N_3_StateIrritação_selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][][];
			// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][][][][] Inflamação_N_3_StateIrritação_selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.nofE][][][][];
			// Create array for replicates of 'FR_Fisiológicos_N_4_StateInflamação_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>,int[][][][]> FR_Fisiológicos_N_4_StateInflamação_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>,int[][][][]>(this.nofE);
			// Create array for replicates of 'FR_Fisiológicos_N_3_StateIrritação_F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]> FR_Fisiológicos_N_3_StateIrritação_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>(this.nofE);
			...
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]> CPTFR_Fisiológicos_F;
			// Create array for 'CPTFR_Fisiológicos' Forwards messages.
			CPTFR_Fisiológicos_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]>(2);
			...
			// Create array for replicates of 'CPTFR_Fisiológicos_itemMáMinusabsorção_N__B'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]> CPTFR_Fisiológicos_itemMáMinusabsorção_N__B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]>(2);
			// Create array for replicates of 'CPTFR_Fisiológicos_itemMáMinusabsorção_N__F'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]> CPTFR_Fisiológicos_itemMáMinusabsorção_N__F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]>(2);
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]> CPTFR_Fisiológicos_use_B;
			// Create array for 'CPTFR_Fisiológicos_use' Backwards messages.
			CPTFR_Fisiológicos_use_B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]>(2);
			// Create array for replicates of 'CPTFR_Fisiológicos_use_F_StateProcessos_infecciosos__StateParasitas__marginal'
			DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]> CPTFR_Fisiológicos_use_F_StateProcessos_infecciosos__StateParasitas__marginal = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>,Vector[][][][]>(2);
			for(int StateProcessos_infecciosos = 0; StateProcessos_infecciosos<2; StateProcessos_infecciosos++) {
				// Create array for 'CPTFR_Fisiológicos' Forwards messages.
				CPTFR_Fisiológicos_F[StateProcessos_infecciosos] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>(2);
				// Create array for replicates of 'CPTFR_Fisiológicos_itemMáMinusabsorção_N__F'
				CPTFR_Fisiológicos_itemMáMinusabsorção_N__F[StateProcessos_infecciosos] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>(2);
				// Create array for replicates of 'CPTFR_Fisiológicos_itemMáMinusabsorção_N__B'
				CPTFR_Fisiológicos_itemMáMinusabsorção_N__B[StateProcessos_infecciosos] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>(2);
				// Create array for 'CPTFR_Fisiológicos_marginal' Forwards messages.
				...
				// Create array for 'CPTFR_Fisiológicos_use' Backwards messages.
				CPTFR_Fisiológicos_use_B[StateProcessos_infecciosos] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>(2);
				// Create array for replicates of 'CPTFR_Fisiológicos_use_F_StateProcessos_infecciosos__StateParasitas__marginal'
				CPTFR_Fisiológicos_use_F_StateProcessos_infecciosos__StateParasitas__marginal[StateProcessos_infecciosos] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,Vector[][][]>(2);
				for(int StateParasitas = 0; StateParasitas<2; StateParasitas++) {
					// Create array for 'CPTFR_Fisiológicos' Forwards messages.
					CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(2);
					for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
						// Create array for 'CPTFR_Fisiológicos' Forwards messages.
						CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(2);
					}
					for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
						for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
							// Create array for 'CPTFR_Fisiológicos' Forwards messages.
							CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação] = new DistributionRefArray<Dirichlet,Vector>(2);
						}
						for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
							for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
								CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação] = ArrayHelper.MakeUniform<Dirichlet>(this.cPTFR_FisiológicosPrior[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação]);
							}
						}
					}
					// Create array for 'CPTFR_Fisiológicos_marginal' Forwards messages.
					...
					// Create array for 'CPTFR_Fisiológicos_use' Backwards messages.
					CPTFR_Fisiológicos_use_B[StateProcessos_infecciosos][StateParasitas] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(2);
					for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
						// Create array for 'CPTFR_Fisiológicos_use' Backwards messages.
						CPTFR_Fisiológicos_use_B[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(2);
					}
					for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
						for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
							// Create array for 'CPTFR_Fisiológicos_use' Backwards messages.
							CPTFR_Fisiológicos_use_B[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação] = new DistributionRefArray<Dirichlet,Vector>(2);
						}
						for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
							for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
								CPTFR_Fisiológicos_use_B[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação] = ArrayHelper.MakeUniform<Dirichlet>(this.cPTFR_FisiológicosPrior[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação]);
							}
						}
					}
					for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
					...
					for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
						...
						for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
							for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
								...
								this.CPTFR_Fisiológicos_marginal_F[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação] = VariableOp.MarginalAverageConditional<Dirichlet>(CPTFR_Fisiológicos_use_B[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação], this.cPTFR_FisiológicosPrior[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação], this.CPTFR_Fisiológicos_marginal_F[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação]);
							}
						}
					}
					// Message to 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' from GetItems factor
					CPTFR_Fisiológicos_use_F_StateProcessos_infecciosos__StateParasitas__marginal[StateProcessos_infecciosos][StateParasitas] = GetItemsOp<Vector[][]>.MarginalInit<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>>(CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas]);
					for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
						for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
							for(int StateMáMinusabsorção = 0; StateMáMinusabsorção<2; StateMáMinusabsorção++) {
								// Message to 'CPTFR_Fisiológicos' from Random factor
								CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação] = ArrayHelper.SetTo<Dirichlet>(CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação], this.cPTFR_FisiológicosPrior[StateProcessos_infecciosos][StateParasitas][StateMáMinusabsorção][StateIrritação][StateInflamação]);
							}
						}
					}
					// Create array for 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' Forwards messages.
					CPTFR_Fisiológicos_itemMáMinusabsorção_N__F[StateProcessos_infecciosos][StateParasitas] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(this.nofE);
					// Create array for 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' Backwards messages.
					CPTFR_Fisiológicos_itemMáMinusabsorção_N__B[StateProcessos_infecciosos][StateParasitas] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(this.nofE);
					// Message to 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' from GetItems factor
					CPTFR_Fisiológicos_use_F_StateProcessos_infecciosos__StateParasitas__marginal[StateProcessos_infecciosos][StateParasitas] = GetItemsOp<Vector[][]>.Marginal<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>>(CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas], CPTFR_Fisiológicos_use_B[StateProcessos_infecciosos][StateParasitas], CPTFR_Fisiológicos_use_F_StateProcessos_infecciosos__StateParasitas__marginal[StateProcessos_infecciosos][StateParasitas]);
				}
			}
			for(int N = 0; N<this.nofE; N++) {
				for(int StateProcessos_infecciosos = 0; StateProcessos_infecciosos<2; StateProcessos_infecciosos++) {
					for(int StateParasitas = 0; StateParasitas<2; StateParasitas++) {
						// Create array for 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' Forwards messages.
						CPTFR_Fisiológicos_itemMáMinusabsorção_N__F[StateProcessos_infecciosos][StateParasitas][N] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(2);
						// Create array for 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' Backwards messages.
						CPTFR_Fisiológicos_itemMáMinusabsorção_N__B[StateProcessos_infecciosos][StateParasitas][N] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(2);
						for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
							// Create array for 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' Forwards messages.
							CPTFR_Fisiológicos_itemMáMinusabsorção_N__F[StateProcessos_infecciosos][StateParasitas][N][StateIrritação] = new DistributionRefArray<Dirichlet,Vector>(2);
							for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
								CPTFR_Fisiológicos_itemMáMinusabsorção_N__F[StateProcessos_infecciosos][StateParasitas][N][StateIrritação][StateInflamação] = ArrayHelper.MakeUniform<Dirichlet>(this.cPTFR_FisiológicosPrior[StateProcessos_infecciosos][StateParasitas][this.máMinusabsorção[N]][StateIrritação][StateInflamação]);
							}
							// Create array for 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' Backwards messages.
							CPTFR_Fisiológicos_itemMáMinusabsorção_N__B[StateProcessos_infecciosos][StateParasitas][N][StateIrritação] = new DistributionRefArray<Dirichlet,Vector>(2);
							for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
								CPTFR_Fisiológicos_itemMáMinusabsorção_N__B[StateProcessos_infecciosos][StateParasitas][N][StateIrritação][StateInflamação] = ArrayHelper.MakeUniform<Dirichlet>(this.cPTFR_FisiológicosPrior[StateProcessos_infecciosos][StateParasitas][this.máMinusabsorção[N]][StateIrritação][StateInflamação]);
							}
						}
						// Message to 'CPTFR_Fisiológicos_itemMáMinusabsorção_N_' from GetItems factor
						CPTFR_Fisiológicos_itemMáMinusabsorção_N__F[StateProcessos_infecciosos][StateParasitas][N] = GetItemsOp<Vector[][]>.ItemsAverageConditional<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>>(CPTFR_Fisiológicos_itemMáMinusabsorção_N__B[StateProcessos_infecciosos][StateParasitas][N], CPTFR_Fisiológicos_F[StateProcessos_infecciosos][StateParasitas], CPTFR_Fisiológicos_use_F_StateProcessos_infecciosos__StateParasitas__marginal[StateProcessos_infecciosos][StateParasitas], this.máMinusabsorção, N, CPTFR_Fisiológicos_itemMáMinusabsorção_N__F[StateProcessos_infecciosos][StateParasitas][N]);
					}
				}
			}
			...
			// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_marginal' Forwards messages.
			this.Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_marginal_F = new DistributionRefArray<Discrete,int>(this.nofE);
			...
			DistributionRefArray<Discrete,int> Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_use_B;
			// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_use' Backwards messages.
			Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_use_B = new DistributionRefArray<Discrete,int>(this.nofE);
			...
			for(int N = 0; N<this.nofE; N++) {
				...
				Câibras_F[N] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
				ProbCâibras_rep_B[N] = ArrayHelper.MakeUniform<Dirichlet>(this.probCâibrasPrior);
				ProbCâibras_rep_F[N] = ArrayHelper.MakeUniform<Dirichlet>(this.probCâibrasPrior);
				// Message to 'ProbCâibras_rep' from Replicate factor
				ProbCâibras_rep_F[N] = ReplicateOp_Divide.UsesAverageConditional<Dirichlet>(ProbCâibras_rep_B[N], ProbCâibras_rep_F_marginal, N, ProbCâibras_rep_F[N]);
				this.Câibras_marginal_F[N] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
				Câibras_use_B[N] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
				// Message to 'Câibras' from Discrete factor
				Câibras_F[N] = DiscreteFromDirichletOp.SampleAverageConditional(ProbCâibras_rep_F[N], Câibras_F[N]);
				// Message to 'Câibras_marginal' from Variable factor
				this.Câibras_marginal_F[N] = VariableOp.MarginalAverageConditional<Discrete>(Câibras_use_B[N], Câibras_F[N], this.Câibras_marginal_F[N]);
				...
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
				...
				ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F[N] = ArrayHelper.MakeUniform<Dirichlet>(this.probPelo_menos_três_evacuações_de_fezes_líquidas_por_diaPrior);
				// Message to 'ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep' from Replicate factor
				ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F[N] = ReplicateOp_Divide.UsesAverageConditional<Dirichlet>(ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_B[N], ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F_marginal, N, ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F[N]);
				this.Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_marginal_F[N] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_use_B[N] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
				// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal'
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal[N] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
				// Create array for replicates of 'Características_definidoras_N_2_StateRuídos_intestinais_hiperativos_F'
				...
				// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F'
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F[N] = new DistributionStructArray<Bernoulli,bool>[2][][];
				// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F'
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F[N] = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>(2);
				// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F'
				Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F[N] = new Discrete[2][][][];
				// Create array for replicates of 'Características_definidoras_N_4_StateCâibras_F'
				Características_definidoras_N_4_StateCâibras_F[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>(2);
				// Create array for replicates of 'Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F'
				Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(2);
				// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B'
				Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B[N] = new DistributionStructArray<Bernoulli,bool>[2][][][];
				// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F'
				Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N] = new DistributionStructArray<Bernoulli,bool>[2][][][];
				// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F'
				Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>(2);
				// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B'
				Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B[N] = new Discrete[2][][][];
				// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B'
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B[N] = new DistributionStructArray<Bernoulli,bool>[2][][];
				// Create array for replicates of 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B_toDef'
				Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B_toDef[N] = new DistributionRefArray<Discrete,int>(2);
				Ruídos_intestinais_hiperativos_F[N] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
				// Create array for replicates of 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F_marginal'
				Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F_marginal[N] = new DistributionRefArray<Discrete,int>(2);
				// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F'
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F[N] = new Discrete[2][][];
				// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B'
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B[N] = new Discrete[2][][];
				// Create array for replicates of 'Características_definidoras_N__StateUrgência_para_evacuar_F'
				Características_definidoras_N__StateUrgência_para_evacuar_F[N] = new DistributionRefArray<Discrete,int>(2);
				// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B_toDef'
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B_toDef[N] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
				// Create array for replicates of 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_cases_uses_B'
				...
				// Message to 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia' from Discrete factor
				Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N] = DiscreteFromDirichletOp.SampleAverageConditional(ProbPelo_menos_três_evacuações_de_fezes_líquidas_por_dia_rep_F[N], Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N]);
				for(int StateUrgência_para_evacuar = 0; StateUrgência_para_evacuar<2; StateUrgência_para_evacuar++) {
					// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal'
					Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal[N][StateUrgência_para_evacuar] = new DistributionRefArray<Discrete,int>(2);
					// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B_toDef'
					Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B_toDef[N][StateUrgência_para_evacuar] = new DistributionRefArray<Discrete,int>(2);
					// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F'
					Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F[N][StateUrgência_para_evacuar] = new Discrete[2][];
					// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B'
					Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B[N][StateUrgência_para_evacuar] = new Discrete[2][];
					// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F'
					Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N][StateUrgência_para_evacuar] = new DistributionStructArray<Bernoulli,bool>[2][][];
					// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F'
					Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F[N][StateUrgência_para_evacuar] = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(2);
					// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F'
					Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F[N][StateUrgência_para_evacuar] = new DistributionStructArray<Bernoulli,bool>[2][];
					// Create array for replicates of 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B'
					Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B[N][StateUrgência_para_evacuar] = new DistributionStructArray<Bernoulli,bool>[2][];
					// Create array for replicates of 'Características_definidoras_N_2_StateRuídos_intestinais_hiperativos_F'
					...
					// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F'
					Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F[N][StateUrgência_para_evacuar] = new Discrete[2][][];
					// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B'
					Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B[N][StateUrgência_para_evacuar] = new Discrete[2][][];
					// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F'
					Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F[N][StateUrgência_para_evacuar] = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>(2);
					// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B'
					Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B[N][StateUrgência_para_evacuar] = new DistributionStructArray<Bernoulli,bool>[2][][];
					// Create array for replicates of 'Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F'
					Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N][StateUrgência_para_evacuar] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
					// Create array for replicates of 'Características_definidoras_N_4_StateCâibras_F'
					Características_definidoras_N_4_StateCâibras_F[N][StateUrgência_para_evacuar] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(2);
					for(int StateRuídos_intestinais_hiperativos = 0; StateRuídos_intestinais_hiperativos<2; StateRuídos_intestinais_hiperativos++) {
						// Message to 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses' from Replicate factor
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = ReplicateOp_Divide.MarginalInit<Discrete>(Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N]);
						// Message to 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses' from Replicate factor
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B_toDef[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = ReplicateOp_Divide.ToDefInit<Discrete>(Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N]);
						// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses' Forwards messages.
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new Discrete[3];
						// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses' Backwards messages.
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new Discrete[3];
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
						// Message to 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses' from Replicate factor
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = ReplicateOp_Divide.Marginal<Discrete>(Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B_toDef[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos], Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N], Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos]);
						// Message to 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses' from Replicate factor
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][0] = ReplicateOp_Divide.UsesAverageConditional<Discrete>(Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][0], Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F_marginal[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos], 0, Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][0]);
						// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases' Forwards messages.
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia = 0; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia<2; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia++) {
							Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = Bernoulli.Uniform();
							// Message to 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases' from CasesInt factor
							Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = IntCasesOp.CasesAverageConditional(Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][0], StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia);
						}
						// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses' Forwards messages.
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionStructArray<Bernoulli,bool>[2];
						// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses' Backwards messages.
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionStructArray<Bernoulli,bool>[2];
						// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses' Backwards messages.
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][0] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia = 0; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia<2; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia++) {
							Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][0][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = Bernoulli.Uniform();
						}
						// Create array for 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses' Forwards messages.
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][1] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia = 0; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia<2; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia++) {
							Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][1][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = Bernoulli.Uniform();
						}
						// Message to 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses' from Replicate factor
						Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][1] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos], Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos], 1, Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][1]);
						...
						// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F'
						Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new Discrete[2][];
						// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B'
						Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new Discrete[2][];
						// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F'
						Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(2);
						// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F'
						Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionStructArray<Bernoulli,bool>[2][];
						// Create array for replicates of 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B'
						Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionStructArray<Bernoulli,bool>[2][];
						// Create array for replicates of 'Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F'
						Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionRefArray<Discrete,int>(2);
						// Create array for replicates of 'Características_definidoras_N_4_StateCâibras_F'
						Características_definidoras_N_4_StateCâibras_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
						for(int StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia = 0; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia<2; StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia++) {
							// Create array for 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses' Forwards messages.
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = new Discrete[2];
							// Create array for 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses' Backwards messages.
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = new Discrete[2];
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
							// Message to 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses' from Replicate factor
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][0] = ReplicateOp_NoDivide.UsesAverageConditional<Discrete>(Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia], Câibras_F[N], 0, Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][0]);
							// Create array for 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases' Forwards messages.
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateCâibras = 0; StateCâibras<2; StateCâibras++) {
								Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][StateCâibras] = Bernoulli.Uniform();
								// Message to 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases' from CasesInt factor
								Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][StateCâibras] = IntCasesOp.CasesAverageConditional(Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][0], StateCâibras);
							}
							// Create array for 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses' Forwards messages.
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = new DistributionStructArray<Bernoulli,bool>[2];
							// Create array for 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses' Backwards messages.
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = new DistributionStructArray<Bernoulli,bool>[2];
							// Create array for 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses' Backwards messages.
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][0] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateCâibras = 0; StateCâibras<2; StateCâibras++) {
								Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][0][StateCâibras] = Bernoulli.Uniform();
							}
							// Create array for 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses' Forwards messages.
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][1] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateCâibras = 0; StateCâibras<2; StateCâibras++) {
								Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][1][StateCâibras] = Bernoulli.Uniform();
							}
							// Message to 'Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses' from Replicate factor
							Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][1] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_B[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia], Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia], 1, Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][1]);
							Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
							// Create array for replicates of 'Características_definidoras_N_4_StateCâibras_F'
							Características_definidoras_N_4_StateCâibras_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = new DistributionRefArray<Discrete,int>(2);
							for(int StateCâibras = 0; StateCâibras<2; StateCâibras++) {
								Características_definidoras_N_4_StateCâibras_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][StateCâibras] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
								// Message to 'Características_definidoras_N_4_StateCâibras' from Discrete factor
								Características_definidoras_N_4_StateCâibras_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][StateCâibras] = DiscreteFromDirichletOp.SampleAverageConditional(CPTCaracterísticas_definidoras_itemDor_abdominal_N__F[StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][N][StateCâibras], Características_definidoras_N_4_StateCâibras_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][StateCâibras]);
							}
							// Message to 'Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia' from Exit factor
							Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Câibras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia][1], Características_definidoras_N_4_StateCâibras_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia], Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia]);
						}
						// Message to 'Características_definidoras_N_2_StateRuídos_intestinais_hiperativos' from Exit factor
						Características_definidoras_N_2_StateRuídos_intestinais_hiperativos_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_N_2_StateRuídos_intestinais_hiperativos_selector_cases_uses_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos][1], Características_definidoras_N_3_StatePelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos], Características_definidoras_N_2_StateRuídos_intestinais_hiperativos_F[N][StateUrgência_para_evacuar][StateRuídos_intestinais_hiperativos]);
					}
					// Message to 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses' from Replicate factor
					Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F_marginal[N][StateUrgência_para_evacuar] = ReplicateOp_Divide.MarginalInit<Discrete>(Ruídos_intestinais_hiperativos_F[N]);
					// Message to 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses' from Replicate factor
					Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B_toDef[N][StateUrgência_para_evacuar] = ReplicateOp_Divide.ToDefInit<Discrete>(Ruídos_intestinais_hiperativos_F[N]);
					// Create array for 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses' Forwards messages.
					Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F[N][StateUrgência_para_evacuar] = new Discrete[4];
					// Create array for 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses' Backwards messages.
					Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B[N][StateUrgência_para_evacuar] = new Discrete[4];
					Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B[N][StateUrgência_para_evacuar][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
					...
					// Message to 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses' from Replicate factor
					Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F_marginal[N][StateUrgência_para_evacuar] = ReplicateOp_Divide.Marginal<Discrete>(Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B_toDef[N][StateUrgência_para_evacuar], Ruídos_intestinais_hiperativos_F[N], Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F_marginal[N][StateUrgência_para_evacuar]);
					// Message to 'Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses' from Replicate factor
					Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F[N][StateUrgência_para_evacuar][0] = ReplicateOp_Divide.UsesAverageConditional<Discrete>(Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_B[N][StateUrgência_para_evacuar][0], Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F_marginal[N][StateUrgência_para_evacuar], 0, Ruídos_intestinais_hiperativos_N__StateUrgência_para_evacuar_selector_uses_F[N][StateUrgência_para_evacuar][0]);
				...
				// Message to 'Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_marginal' from Variable factor
				this.Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_marginal_F[N] = VariableOp.MarginalAverageConditional<Discrete>(Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_use_B[N], Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_F[N], this.Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_marginal_F[N]);
				...
				// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_F_marginal'
				Irritação_N_2_StateParasitas_selector_uses_F_marginal[N] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
				// Create array for replicates of 'Parasitas_N__StateProcessos_infecciosos_selector_cases_uses_F'
				...
				// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_F'
				Irritação_N_2_StateParasitas_selector_uses_F[N] = new Discrete[2][][];
				// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_B'
				Irritação_N_2_StateParasitas_selector_uses_B[N] = new Discrete[2][][];
				// Create array for replicates of 'Parasitas_N__StateProcessos_infecciosos_selector_cases_uses_B'
				Parasitas_N__StateProcessos_infecciosos_selector_cases_uses_B[N] = new DistributionStructArray<Bernoulli,bool>[2][];
				// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_B_toDef'
				Irritação_N_2_StateParasitas_selector_uses_B_toDef[N] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
				// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_uses_B'
				Irritação_N_2_StateParasitas_selector_cases_uses_B[N] = new DistributionStructArray<Bernoulli,bool>[2][][];
				// Create array for replicates of 'FR_Fisiológicos_N_2_StateParasitas_F'
				FR_Fisiológicos_N_2_StateParasitas_F[N] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
				// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_uses_F'
				Inflamação_N_3_StateIrritação_selector_uses_F[N] = new Discrete[2][][][];
				// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_uses_B'
				Inflamação_N_3_StateIrritação_selector_uses_B[N] = new Discrete[2][][][];
				// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_F'
				Inflamação_N_3_StateIrritação_selector_cases_F[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>(2);
				// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_uses_F'
				Inflamação_N_3_StateIrritação_selector_cases_uses_F[N] = new DistributionStructArray<Bernoulli,bool>[2][][][];
				// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_uses_B'
				Inflamação_N_3_StateIrritação_selector_cases_uses_B[N] = new DistributionStructArray<Bernoulli,bool>[2][][][];
				// Create array for replicates of 'FR_Fisiológicos_N_3_StateIrritação_F'
				FR_Fisiológicos_N_3_StateIrritação_F[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(2);
				// Create array for replicates of 'FR_Fisiológicos_N_4_StateInflamação_F'
				FR_Fisiológicos_N_4_StateInflamação_F[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>,int[][][]>(2);
				// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_F'
				Irritação_N_2_StateParasitas_selector_cases_F[N] = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>(2);
				// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_uses_F'
				Irritação_N_2_StateParasitas_selector_cases_uses_F[N] = new DistributionStructArray<Bernoulli,bool>[2][][];
				...
				for(int StateProcessos_infecciosos = 0; StateProcessos_infecciosos<2; StateProcessos_infecciosos++) {
					// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_F_marginal'
					Irritação_N_2_StateParasitas_selector_uses_F_marginal[N][StateProcessos_infecciosos] = new DistributionRefArray<Discrete,int>(2);
					// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_B_toDef'
					Irritação_N_2_StateParasitas_selector_uses_B_toDef[N][StateProcessos_infecciosos] = new DistributionRefArray<Discrete,int>(2);
					// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_uses_B'
					Inflamação_N_3_StateIrritação_selector_cases_uses_B[N][StateProcessos_infecciosos] = new DistributionStructArray<Bernoulli,bool>[2][][];
					// Create array for replicates of 'FR_Fisiológicos_N_4_StateInflamação_F'
					FR_Fisiológicos_N_4_StateInflamação_F[N][StateProcessos_infecciosos] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(2);
					// Create array for replicates of 'FR_Fisiológicos_N_3_StateIrritação_F'
					FR_Fisiológicos_N_3_StateIrritação_F[N][StateProcessos_infecciosos] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
					// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_uses_F'
					Inflamação_N_3_StateIrritação_selector_cases_uses_F[N][StateProcessos_infecciosos] = new DistributionStructArray<Bernoulli,bool>[2][][];
					// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_F'
					Inflamação_N_3_StateIrritação_selector_cases_F[N][StateProcessos_infecciosos] = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>(2);
					// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_F'
					Irritação_N_2_StateParasitas_selector_uses_F[N][StateProcessos_infecciosos] = new Discrete[2][];
					// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_uses_B'
					Irritação_N_2_StateParasitas_selector_uses_B[N][StateProcessos_infecciosos] = new Discrete[2][];
					// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_F'
					Irritação_N_2_StateParasitas_selector_cases_F[N][StateProcessos_infecciosos] = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(2);
					// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_uses_F'
					Irritação_N_2_StateParasitas_selector_cases_uses_F[N][StateProcessos_infecciosos] = new DistributionStructArray<Bernoulli,bool>[2][];
					// Create array for replicates of 'Irritação_N_2_StateParasitas_selector_cases_uses_B'
					Irritação_N_2_StateParasitas_selector_cases_uses_B[N][StateProcessos_infecciosos] = new DistributionStructArray<Bernoulli,bool>[2][];
					// Create array for replicates of 'FR_Fisiológicos_N_2_StateParasitas_F'
					FR_Fisiológicos_N_2_StateParasitas_F[N][StateProcessos_infecciosos] = new DistributionRefArray<Discrete,int>(2);
					// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_uses_F'
					Inflamação_N_3_StateIrritação_selector_uses_F[N][StateProcessos_infecciosos] = new Discrete[2][][];
					// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_uses_B'
					Inflamação_N_3_StateIrritação_selector_uses_B[N][StateProcessos_infecciosos] = new Discrete[2][][];
					for(int StateParasitas = 0; StateParasitas<2; StateParasitas++) {
						// Message to 'Irritação_N_2_StateParasitas_selector_uses' from Replicate factor
						Irritação_N_2_StateParasitas_selector_uses_F_marginal[N][StateProcessos_infecciosos][StateParasitas] = ReplicateOp_Divide.MarginalInit<Discrete>(Irritação_F[N]);
						// Message to 'Irritação_N_2_StateParasitas_selector_uses' from Replicate factor
						Irritação_N_2_StateParasitas_selector_uses_B_toDef[N][StateProcessos_infecciosos][StateParasitas] = ReplicateOp_Divide.ToDefInit<Discrete>(Irritação_F[N]);
						// Create array for 'Irritação_N_2_StateParasitas_selector_uses' Forwards messages.
						Irritação_N_2_StateParasitas_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas] = new Discrete[3];
						// Create array for 'Irritação_N_2_StateParasitas_selector_uses' Backwards messages.
						Irritação_N_2_StateParasitas_selector_uses_B[N][StateProcessos_infecciosos][StateParasitas] = new Discrete[3];
						Irritação_N_2_StateParasitas_selector_uses_B[N][StateProcessos_infecciosos][StateParasitas][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
						Irritação_N_2_StateParasitas_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
						// Message to 'Irritação_N_2_StateParasitas_selector_uses' from Replicate factor
						Irritação_N_2_StateParasitas_selector_uses_F_marginal[N][StateProcessos_infecciosos][StateParasitas] = ReplicateOp_Divide.Marginal<Discrete>(Irritação_N_2_StateParasitas_selector_uses_B_toDef[N][StateProcessos_infecciosos][StateParasitas], Irritação_F[N], Irritação_N_2_StateParasitas_selector_uses_F_marginal[N][StateProcessos_infecciosos][StateParasitas]);
						// Message to 'Irritação_N_2_StateParasitas_selector_uses' from Replicate factor
						Irritação_N_2_StateParasitas_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][0] = ReplicateOp_Divide.UsesAverageConditional<Discrete>(Irritação_N_2_StateParasitas_selector_uses_B[N][StateProcessos_infecciosos][StateParasitas][0], Irritação_N_2_StateParasitas_selector_uses_F_marginal[N][StateProcessos_infecciosos][StateParasitas], 0, Irritação_N_2_StateParasitas_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][0]);
						// Create array for 'Irritação_N_2_StateParasitas_selector_cases' Forwards messages.
						Irritação_N_2_StateParasitas_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
							Irritação_N_2_StateParasitas_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = Bernoulli.Uniform();
							// Message to 'Irritação_N_2_StateParasitas_selector_cases' from CasesInt factor
							Irritação_N_2_StateParasitas_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = IntCasesOp.CasesAverageConditional(Irritação_N_2_StateParasitas_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][0], StateIrritação);
						}
						// Create array for 'Irritação_N_2_StateParasitas_selector_cases_uses' Forwards messages.
						Irritação_N_2_StateParasitas_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas] = new DistributionStructArray<Bernoulli,bool>[2];
						// Create array for 'Irritação_N_2_StateParasitas_selector_cases_uses' Backwards messages.
						Irritação_N_2_StateParasitas_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas] = new DistributionStructArray<Bernoulli,bool>[2];
						// Create array for 'Irritação_N_2_StateParasitas_selector_cases_uses' Backwards messages.
						Irritação_N_2_StateParasitas_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas][0] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
							Irritação_N_2_StateParasitas_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas][0][StateIrritação] = Bernoulli.Uniform();
						}
						// Create array for 'Irritação_N_2_StateParasitas_selector_cases_uses' Forwards messages.
						Irritação_N_2_StateParasitas_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][1] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
							Irritação_N_2_StateParasitas_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][1][StateIrritação] = Bernoulli.Uniform();
						}
						// Message to 'Irritação_N_2_StateParasitas_selector_cases_uses' from Replicate factor
						Irritação_N_2_StateParasitas_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][1] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(Irritação_N_2_StateParasitas_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas], Irritação_N_2_StateParasitas_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas], 1, Irritação_N_2_StateParasitas_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][1]);
						...
						// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_uses_F'
						Inflamação_N_3_StateIrritação_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas] = new Discrete[2][];
						// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_uses_B'
						Inflamação_N_3_StateIrritação_selector_uses_B[N][StateProcessos_infecciosos][StateParasitas] = new Discrete[2][];
						// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_F'
						Inflamação_N_3_StateIrritação_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas] = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(2);
						// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_uses_F'
						Inflamação_N_3_StateIrritação_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas] = new DistributionStructArray<Bernoulli,bool>[2][];
						// Create array for replicates of 'Inflamação_N_3_StateIrritação_selector_cases_uses_B'
						Inflamação_N_3_StateIrritação_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas] = new DistributionStructArray<Bernoulli,bool>[2][];
						// Create array for replicates of 'FR_Fisiológicos_N_3_StateIrritação_F'
						FR_Fisiológicos_N_3_StateIrritação_F[N][StateProcessos_infecciosos][StateParasitas] = new DistributionRefArray<Discrete,int>(2);
						// Create array for replicates of 'FR_Fisiológicos_N_4_StateInflamação_F'
						FR_Fisiológicos_N_4_StateInflamação_F[N][StateProcessos_infecciosos][StateParasitas] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
						for(int StateIrritação = 0; StateIrritação<2; StateIrritação++) {
							// Create array for 'Inflamação_N_3_StateIrritação_selector_uses' Forwards messages.
							Inflamação_N_3_StateIrritação_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = new Discrete[2];
							// Create array for 'Inflamação_N_3_StateIrritação_selector_uses' Backwards messages.
							Inflamação_N_3_StateIrritação_selector_uses_B[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = new Discrete[2];
							Inflamação_N_3_StateIrritação_selector_uses_B[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
							Inflamação_N_3_StateIrritação_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
							// Message to 'Inflamação_N_3_StateIrritação_selector_uses' from Replicate factor
							Inflamação_N_3_StateIrritação_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][0] = ReplicateOp_NoDivide.UsesAverageConditional<Discrete>(Inflamação_N_3_StateIrritação_selector_uses_B[N][StateProcessos_infecciosos][StateParasitas][StateIrritação], Inflamação_F[N], 0, Inflamação_N_3_StateIrritação_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][0]);
							// Create array for 'Inflamação_N_3_StateIrritação_selector_cases' Forwards messages.
							Inflamação_N_3_StateIrritação_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
								Inflamação_N_3_StateIrritação_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][StateInflamação] = Bernoulli.Uniform();
								// Message to 'Inflamação_N_3_StateIrritação_selector_cases' from CasesInt factor
								Inflamação_N_3_StateIrritação_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][StateInflamação] = IntCasesOp.CasesAverageConditional(Inflamação_N_3_StateIrritação_selector_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][0], StateInflamação);
							}
							// Create array for 'Inflamação_N_3_StateIrritação_selector_cases_uses' Forwards messages.
							Inflamação_N_3_StateIrritação_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = new DistributionStructArray<Bernoulli,bool>[2];
							// Create array for 'Inflamação_N_3_StateIrritação_selector_cases_uses' Backwards messages.
							Inflamação_N_3_StateIrritação_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = new DistributionStructArray<Bernoulli,bool>[2];
							// Create array for 'Inflamação_N_3_StateIrritação_selector_cases_uses' Backwards messages.
							Inflamação_N_3_StateIrritação_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][0] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
								Inflamação_N_3_StateIrritação_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][0][StateInflamação] = Bernoulli.Uniform();
							}
							// Create array for 'Inflamação_N_3_StateIrritação_selector_cases_uses' Forwards messages.
							Inflamação_N_3_StateIrritação_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][1] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
								Inflamação_N_3_StateIrritação_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][1][StateInflamação] = Bernoulli.Uniform();
							}
							// Message to 'Inflamação_N_3_StateIrritação_selector_cases_uses' from Replicate factor
							Inflamação_N_3_StateIrritação_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][1] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(Inflamação_N_3_StateIrritação_selector_cases_uses_B[N][StateProcessos_infecciosos][StateParasitas][StateIrritação], Inflamação_N_3_StateIrritação_selector_cases_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação], 1, Inflamação_N_3_StateIrritação_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][1]);
							FR_Fisiológicos_N_3_StateIrritação_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
							// Create array for replicates of 'FR_Fisiológicos_N_4_StateInflamação_F'
							FR_Fisiológicos_N_4_StateInflamação_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = new DistributionRefArray<Discrete,int>(2);
							for(int StateInflamação = 0; StateInflamação<2; StateInflamação++) {
								FR_Fisiológicos_N_4_StateInflamação_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][StateInflamação] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
								// Message to 'FR_Fisiológicos_N_4_StateInflamação' from Discrete factor
								FR_Fisiológicos_N_4_StateInflamação_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][StateInflamação] = DiscreteFromDirichletOp.SampleAverageConditional(CPTFR_Fisiológicos_itemMáMinusabsorção_N__F[StateProcessos_infecciosos][StateParasitas][N][StateIrritação][StateInflamação], FR_Fisiológicos_N_4_StateInflamação_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][StateInflamação]);
							}
							// Message to 'FR_Fisiológicos_N_3_StateIrritação' from Exit factor
							FR_Fisiológicos_N_3_StateIrritação_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Inflamação_N_3_StateIrritação_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação][1], FR_Fisiológicos_N_4_StateInflamação_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação], FR_Fisiológicos_N_3_StateIrritação_F[N][StateProcessos_infecciosos][StateParasitas][StateIrritação]);
						}
						// Message to 'FR_Fisiológicos_N_2_StateParasitas' from Exit factor
						FR_Fisiológicos_N_2_StateParasitas_F[N][StateProcessos_infecciosos][StateParasitas] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Irritação_N_2_StateParasitas_selector_cases_uses_F[N][StateProcessos_infecciosos][StateParasitas][1], FR_Fisiológicos_N_3_StateIrritação_F[N][StateProcessos_infecciosos][StateParasitas], FR_Fisiológicos_N_2_StateParasitas_F[N][StateProcessos_infecciosos][StateParasitas]);
					}
					...
					Parasitas_N__StateProcessos_infecciosos_selector_uses_F[N][StateProcessos_infecciosos] = new Discrete[4];
					// Create array for 'Parasitas_N__StateProcessos_infecciosos_selector_uses' Backwards messages.
					Parasitas_N__StateProcessos_infecciosos_selector_uses_B[N][StateProcessos_infecciosos] = new Discrete[4];
				...
				// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F'
				Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F[N] = new Discrete[2][][][];
				// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B'
				FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N] = new DistributionStructArray<Bernoulli,bool>[2][][];
				// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B'
				Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B[N] = new Discrete[2][][][];
				// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F'
				Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>,bool[][][]>(2);
				// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F'
				Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N] = new DistributionStructArray<Bernoulli,bool>[2][][][];
				// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F'
				FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F[N] = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>(2);
				// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F'
				FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N] = new DistributionStructArray<Bernoulli,bool>[2][][];
				// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal'
				Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(2);
				// Create array for replicates of 'Diarreia_N__StateFR_Psicológicos_F'
				...
				// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F'
				FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F[N] = new Discrete[2][][];
				// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B'
				FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B[N] = new Discrete[2][][];
				// Create array for replicates of 'Diarreia_N_4_StateCaracterísticas_definidoras_F'
				...
				// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B'
				Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N] = new DistributionStructArray<Bernoulli,bool>[2][][][];
				// Create array for replicates of 'Diarreia_N_3_StateFR_Fisiológicos_F'
				...
				// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef'
				Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef[N] = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>,int[][]>(2);
				// Create array for replicates of 'FR_Situacionais_N_9_StateFR_Psicológicos_selector_cases_uses_B'
				...
				// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B_toDef'
				FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B_toDef[N] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
				// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal'
				FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal[N] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
				...
				Processos_infecciosos_N__selector_uses_F[N] = new Discrete[5];
				...
				Processos_infecciosos_N__selector_uses_B[N] = new Discrete[5];
				...
				Urgência_para_evacuar_N__selector_uses_F[N] = new Discrete[5];
				...
				Urgência_para_evacuar_N__selector_uses_B[N] = new Discrete[5];
				...
				for(int StateFR_Psicológicos = 0; StateFR_Psicológicos<2; StateFR_Psicológicos++) {
					...
					// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal'
					FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal[N][StateFR_Psicológicos] = new DistributionRefArray<Discrete,int>(2);
					// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B'
					Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos] = new DistributionStructArray<Bernoulli,bool>[2][][];
					// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B_toDef'
					FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B_toDef[N][StateFR_Psicológicos] = new DistributionRefArray<Discrete,int>(2);
					// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F'
					FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F[N][StateFR_Psicológicos] = new Discrete[2][];
					// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B'
					FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B[N][StateFR_Psicológicos] = new Discrete[2][];
					// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F'
					FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F[N][StateFR_Psicológicos] = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(2);
					// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F'
					FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos] = new DistributionStructArray<Bernoulli,bool>[2][];
					// Create array for replicates of 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B'
					FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos] = new DistributionStructArray<Bernoulli,bool>[2][];
					// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F'
					Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F[N][StateFR_Psicológicos] = new Discrete[2][][];
					// Create array for replicates of 'Diarreia_N_2_StateFR_Situacionais_F'
					Diarreia_N_2_StateFR_Situacionais_F[N][StateFR_Psicológicos] = new DistributionRefArray<Discrete,int>(2);
					// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B'
					Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B[N][StateFR_Psicológicos] = new Discrete[2][][];
					// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F'
					Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F[N][StateFR_Psicológicos] = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>,bool[][]>(2);
					// Create array for replicates of 'Diarreia_N_3_StateFR_Fisiológicos_F'
					...
					// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal'
					Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal[N][StateFR_Psicológicos] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
					// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef'
					Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef[N][StateFR_Psicológicos] = new DistributionRefArray<DistributionRefArray<Discrete,int>,int[]>(2);
					// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F'
					Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos] = new DistributionStructArray<Bernoulli,bool>[2][][];
					// Create array for replicates of 'Outro_diagnóstico_N_2_StateFR_Situacionais_F'
					...
					for(int StateFR_Situacionais = 0; StateFR_Situacionais<2; StateFR_Situacionais++) {
						// Message to 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses' from Replicate factor
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais] = ReplicateOp_Divide.MarginalInit<Discrete>(FR_Fisiológicos_F[N]);
						// Message to 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses' from Replicate factor
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B_toDef[N][StateFR_Psicológicos][StateFR_Situacionais] = ReplicateOp_Divide.ToDefInit<Discrete>(FR_Fisiológicos_F[N]);
						// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal'
						Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais] = new DistributionRefArray<Discrete,int>(2);
						// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B'
						Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais] = new Discrete[2][];
						// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef'
						Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef[N][StateFR_Psicológicos][StateFR_Situacionais] = new DistributionRefArray<Discrete,int>(2);
						// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F'
						Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais] = new Discrete[2][];
						// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F'
						Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais] = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(2);
						// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F'
						Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais] = new DistributionStructArray<Bernoulli,bool>[2][];
						// Create array for replicates of 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B'
						Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais] = new DistributionStructArray<Bernoulli,bool>[2][];
						// Create array for replicates of 'Outro_diagnóstico_N_3_StateFR_Fisiológicos_F'
						...
						for(int StateFR_Fisiológicos = 0; StateFR_Fisiológicos<2; StateFR_Fisiológicos++) {
							// Message to 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses' from Replicate factor
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = ReplicateOp_Divide.MarginalInit<Discrete>(Características_definidoras_F[N]);
							// Message to 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses' from Replicate factor
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = ReplicateOp_Divide.ToDefInit<Discrete>(Características_definidoras_F[N]);
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses' Forwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = new Discrete[3];
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses' Backwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = new Discrete[3];
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
							// Message to 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses' from Replicate factor
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = ReplicateOp_Divide.Marginal<Discrete>(Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B_toDef[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos], Características_definidoras_F[N], Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos]);
							// Message to 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses' from Replicate factor
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][0] = ReplicateOp_Divide.UsesAverageConditional<Discrete>(Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][0], Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos], 0, Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][0]);
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases' Forwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateCaracterísticas_definidoras = 0; StateCaracterísticas_definidoras<2; StateCaracterísticas_definidoras++) {
								Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][StateCaracterísticas_definidoras] = Bernoulli.Uniform();
								// Message to 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases' from CasesInt factor
								Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][StateCaracterísticas_definidoras] = IntCasesOp.CasesAverageConditional(Características_definidoras_N_7_StateFR_Fisiológicos_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][0], StateCaracterísticas_definidoras);
							}
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' Forwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = new DistributionStructArray<Bernoulli,bool>[3];
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' Backwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = new DistributionStructArray<Bernoulli,bool>[3];
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' Backwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][0] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateCaracterísticas_definidoras = 0; StateCaracterísticas_definidoras<2; StateCaracterísticas_definidoras++) {
								Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][0][StateCaracterísticas_definidoras] = Bernoulli.Uniform();
							}
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' Forwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][1] = new DistributionStructArray<Bernoulli,bool>(2);
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' Backwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][1] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateCaracterísticas_definidoras = 0; StateCaracterísticas_definidoras<2; StateCaracterísticas_definidoras++) {
								Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][1][StateCaracterísticas_definidoras] = Bernoulli.Uniform();
								Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][1][StateCaracterísticas_definidoras] = Bernoulli.Uniform();
							}
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' Forwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][2] = new DistributionStructArray<Bernoulli,bool>(2);
							// Create array for 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' Backwards messages.
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][2] = new DistributionStructArray<Bernoulli,bool>(2);
							for(int StateCaracterísticas_definidoras = 0; StateCaracterísticas_definidoras<2; StateCaracterísticas_definidoras++) {
								Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][2][StateCaracterísticas_definidoras] = Bernoulli.Uniform();
								Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][2][StateCaracterísticas_definidoras] = Bernoulli.Uniform();
							}
							// Message to 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' from Replicate factor
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][1] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos], Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos], 1, Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][1]);
							// Message to 'Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses' from Replicate factor
							Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][2] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos], Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos], 2, Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][2]);
							...
							Outro_diagnóstico_N_3_StateFR_Fisiológicos_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Características_definidoras_N_7_StateFR_Fisiológicos_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos][2], Outro_diagnóstico_N_4_StateCaracterísticas_definidoras_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos], Outro_diagnóstico_N_3_StateFR_Fisiológicos_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos]);
						}
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses' Forwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais] = new Discrete[4];
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses' Backwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais] = new Discrete[4];
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
						// Message to 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses' from Replicate factor
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais] = ReplicateOp_Divide.Marginal<Discrete>(FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B_toDef[N][StateFR_Psicológicos][StateFR_Situacionais], FR_Fisiológicos_F[N], FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais]);
						// Message to 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses' from Replicate factor
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][0] = ReplicateOp_Divide.UsesAverageConditional<Discrete>(FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][0], FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F_marginal[N][StateFR_Psicológicos][StateFR_Situacionais], 0, FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][0]);
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases' Forwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StateFR_Fisiológicos = 0; StateFR_Fisiológicos<2; StateFR_Fisiológicos++) {
							FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = Bernoulli.Uniform();
							// Message to 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases' from CasesInt factor
							FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais][StateFR_Fisiológicos] = IntCasesOp.CasesAverageConditional(FR_Fisiológicos_N_6_StateFR_Situacionais_selector_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][0], StateFR_Fisiológicos);
						}
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' Forwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais] = new DistributionStructArray<Bernoulli,bool>[3];
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' Backwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais] = new DistributionStructArray<Bernoulli,bool>[3];
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' Backwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][0] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StateFR_Fisiológicos = 0; StateFR_Fisiológicos<2; StateFR_Fisiológicos++) {
							FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][0][StateFR_Fisiológicos] = Bernoulli.Uniform();
						}
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' Forwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][1] = new DistributionStructArray<Bernoulli,bool>(2);
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' Backwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][1] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StateFR_Fisiológicos = 0; StateFR_Fisiológicos<2; StateFR_Fisiológicos++) {
							FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][1][StateFR_Fisiológicos] = Bernoulli.Uniform();
							FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][1][StateFR_Fisiológicos] = Bernoulli.Uniform();
						}
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' Forwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][2] = new DistributionStructArray<Bernoulli,bool>(2);
						// Create array for 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' Backwards messages.
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][2] = new DistributionStructArray<Bernoulli,bool>(2);
						for(int StateFR_Fisiológicos = 0; StateFR_Fisiológicos<2; StateFR_Fisiológicos++) {
							FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais][2][StateFR_Fisiológicos] = Bernoulli.Uniform();
							FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][2][StateFR_Fisiológicos] = Bernoulli.Uniform();
						}
						// Message to 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' from Replicate factor
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][1] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais], FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais], 1, FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][1]);
						// Message to 'FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses' from Replicate factor
						FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][2] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_B[N][StateFR_Psicológicos][StateFR_Situacionais], FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_F[N][StateFR_Psicológicos][StateFR_Situacionais], 2, FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][2]);
						...
						Diarreia_N_2_StateFR_Situacionais_F[N][StateFR_Psicológicos][StateFR_Situacionais] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][1], Diarreia_N_3_StateFR_Fisiológicos_F[N][StateFR_Psicológicos][StateFR_Situacionais], Diarreia_N_2_StateFR_Situacionais_F[N][StateFR_Psicológicos][StateFR_Situacionais]);
						...
						Outro_diagnóstico_N_2_StateFR_Situacionais_F[N][StateFR_Psicológicos][StateFR_Situacionais] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(FR_Fisiológicos_N_6_StateFR_Situacionais_selector_cases_uses_F[N][StateFR_Psicológicos][StateFR_Situacionais][2], Outro_diagnóstico_N_3_StateFR_Fisiológicos_F[N][StateFR_Psicológicos][StateFR_Situacionais], Outro_diagnóstico_N_2_StateFR_Situacionais_F[N][StateFR_Psicológicos][StateFR_Situacionais]);
					}
				...
				Controle_Hidroeletrolítico_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][2], Controle_Hidroeletrolítico_N__StateDiarreia_F[N], Controle_Hidroeletrolítico_F[N]);
				...
				Cotrole_da_Diarreia_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][3], Cotrole_da_Diarreia_N__StateDiarreia_F[N], Cotrole_da_Diarreia_F[N]);
				...
				Controle_da_Nutrição_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][4], Controle_da_Nutrição_N__StateDiarreia_F[N], Controle_da_Nutrição_F[N]);
				...
				Controle_Intestinal_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][5], Controle_Intestinal_N__StateDiarreia_F[N], Controle_Intestinal_F[N]);
				...
				Controle_de_Medicamentos_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][6], Controle_de_Medicamentos_N__StateDiarreia_F[N], Controle_de_Medicamentos_F[N]);
				...
				Controle_Hídrico_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][7], Controle_Hídrico_N__StateDiarreia_F[N], Controle_Hídrico_F[N]);
				...
				Controle_da_Dor_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][8], Controle_da_Dor_N__StateDiarreia_F[N], Controle_da_Dor_F[N]);
				...
				Suporte_Emocional_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][10], Suporte_Emocional_N__StateDiarreia_F[N], Suporte_Emocional_F[N]);
			...
			this.Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40_isDone = true;
		}
		...
		/// <summary>Computations that depend on the observed value of MáMinusabsorção and NofE</summary>
		private void Changed_MáMinusabsorção_NofE()
		{
			if (this.Changed_MáMinusabsorção_NofE_isDone) {
				return ;
			}
			this.MáMinusabsorção_marginal = new DistributionRefArray<Discrete,int>(this.nofE, delegate(int N) {
				return ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(2));
			});
			this.MáMinusabsorção_marginal = Distribution.SetPoint<DistributionRefArray<Discrete,int>,int[]>(this.MáMinusabsorção_marginal, this.máMinusabsorção);
			this.Changed_MáMinusabsorção_NofE_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of MáMinusabsorção and NofE and ProbMáMinusabsorçãoPrior</summary>
		private void Changed_MáMinusabsorção_NofE_ProbMáMinusabsorçãoPrior()
		{
			if (this.Changed_MáMinusabsorção_NofE_ProbMáMinusabsorçãoPrior_isDone) {
				return ;
			}
			...
			for(int N = 0; N<this.nofE; N++) {
				...
				// Message to 'ProbMáMinusabsorção_rep' from Discrete factor
				ProbMáMinusabsorção_rep_B[N] = DiscreteFromDirichletOp.ProbsAverageConditional(this.máMinusabsorção[N], ProbMáMinusabsorção_rep_B[N]);
			}
			...
			// Message to 'ProbMáMinusabsorção_rep' from Replicate factor
			ProbMáMinusabsorção_rep_B_toDef = ReplicateOp_Divide.ToDef<Dirichlet>(ProbMáMinusabsorção_rep_B, ProbMáMinusabsorção_rep_B_toDef);
			...
			this.Changed_MáMinusabsorção_NofE_ProbMáMinusabsorçãoPrior_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_MáMinusabsorção_NofE_ProbMáMinusabsorçãoPrior();
			this.Changed_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoPrior_CPT40();
			...
			this.Changed_MáMinusabsorção_NofE();
		...
		{
			return this.MáMinusabsorção_marginal;
		}
		...
		{
			return this.Pelo_menos_três_evacuações_de_fezes_líquidas_por_dia_marginal_F;
		}
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="MáMinusabsorção") {
				this.MáMinusabsorção = (int[])value;
				return ;
			}
			if (variableName=="ProbRadiaçãoPrior") {
