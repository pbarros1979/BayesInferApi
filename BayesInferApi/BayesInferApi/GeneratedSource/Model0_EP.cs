...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.1810.501 at 11:11 on sexta-feira, 9 de agosto de 2019.
	/// </remarks>
	public partial class Model0_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_Câibras_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoP41()
		{
			...
			for(int N = 0; N<this.nofE; N++) {
				...
				Suporte_Emocional_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][2], Suporte_Emocional_N__StateDiarreia_F[N], Suporte_Emocional_F[N]);
				...
				Controle_Intestinal_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][3], Controle_Intestinal_N__StateDiarreia_F[N], Controle_Intestinal_F[N]);
				...
				Controle_de_Medicamentos_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][4], Controle_de_Medicamentos_N__StateDiarreia_F[N], Controle_de_Medicamentos_F[N]);
				...
				Controle_de_Eletrólitos_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][6], Controle_de_Eletrólitos_N__StateDiarreia_F[N], Controle_de_Eletrólitos_F[N]);
				...
				Cotrole_da_Diarreia_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][7], Cotrole_da_Diarreia_N__StateDiarreia_F[N], Cotrole_da_Diarreia_F[N]);
				...
				Cuidados_com_Ostomias_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][8], Cuidados_com_Ostomias_N__StateDiarreia_F[N], Cuidados_com_Ostomias_F[N]);
				...
				Controle_da_Nutrição_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][9], Controle_da_Nutrição_N__StateDiarreia_F[N], Controle_da_Nutrição_F[N]);
				...
				Controle_da_Dor_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][10], Controle_da_Dor_N__StateDiarreia_F[N], Controle_da_Dor_F[N]);
