...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.1810.501 at 11:03 on sexta-feira, 9 de agosto de 2019.
	/// </remarks>
	public partial class Model0_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_Câibras_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoP41()
		{
			...
			for(int N = 0; N<this.nofE; N++) {
				...
				Controle_de_Medicamentos_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][2], Controle_de_Medicamentos_N__StateDiarreia_F[N], Controle_de_Medicamentos_F[N]);
				...
				Suporte_Emocional_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][3], Suporte_Emocional_N__StateDiarreia_F[N], Suporte_Emocional_F[N]);
				...
				Controle_Intestinal_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][4], Controle_Intestinal_N__StateDiarreia_F[N], Controle_Intestinal_F[N]);
				...
				Cotrole_da_Diarreia_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][5], Cotrole_da_Diarreia_N__StateDiarreia_F[N], Cotrole_da_Diarreia_F[N]);
				...
				Controle_Hídrico_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][6], Controle_Hídrico_N__StateDiarreia_F[N], Controle_Hídrico_F[N]);
				...
				Controle_Hidroeletrolítico_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][7], Controle_Hidroeletrolítico_N__StateDiarreia_F[N], Controle_Hidroeletrolítico_F[N]);
				...
				Cuidados_com_Ostomias_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][10], Cuidados_com_Ostomias_N__StateDiarreia_F[N], Cuidados_com_Ostomias_F[N]);
