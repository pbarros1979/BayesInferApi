...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.1810.501 at 10:57 on sexta-feira, 9 de agosto de 2019.
	/// </remarks>
	public partial class Model1_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_Câibras_CPTCaracterísticas_definidorasPrior_CPTControle_da_DorPrior_CPTControle_da_NutriçãoP41()
		{
			...
			for(int N = 0; N<this.nofE; N++) {
				...
				Controle_da_Dor_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][6], Controle_da_Dor_N__StateDiarreia_F[N], Controle_da_Dor_F[N]);
				...
				Controle_Hídrico_F[N] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(Diarreia_N__selector_cases_uses_F[N][8], Controle_Hídrico_N__StateDiarreia_F[N], Controle_Hídrico_F[N]);
